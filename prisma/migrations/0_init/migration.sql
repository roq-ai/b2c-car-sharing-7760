...
-- AddForeignKey
ALTER TABLE "operations_dashboard" ADD CONSTRAINT "operations_dashboard_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
