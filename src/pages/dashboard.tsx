...
function DashboardPage() {
  ...
  const operationsDashboardStat = useSWR<PaginatedInterface<OperationsDashboardInterface>>(
    () => `/operations-dashboards`,
    () => getOperationsDashboards({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      ...
      result: operationsDashboardStat?.data?.totalCount,
