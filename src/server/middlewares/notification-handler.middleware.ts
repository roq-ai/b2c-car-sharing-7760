...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'vehicle.maintenance.update': {
    roles: ['owner', 'admin', 'business-owner', 'operations-manager', 'operations-staff'],
    key: 'vehicle',
    tenantPath: [],
    userPath: [],
  },
  'complaint.create.create': {
    roles: ['owner', 'admin', 'business-owner', 'operations-manager', 'customer-service-representative'],
    key: 'complaint',
    tenantPath: [],
    userPath: [],
  },
